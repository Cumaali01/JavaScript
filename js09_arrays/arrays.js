...
console.log(a);
console.log(a[0]);
// ! 1.Method (Array Literal) - Most common method
const names = ["James", "John", "Harry", "Josh", "Matthew"];
console.log(names);
console.log(typeof names);
console.log(names.length);

names.splice(1, 1, "Ralph"); //* write in 1. index and second 1 is to erase John
console.log(names);
...
//? Plus or minus, arrays of numbers!!!
console.log(numbers);
numbers[numbers.length - 1]++;
numbers[0]--; //* minus 1 for the first index
console.log(numbers);

const ages = [22, 44, 55];
const people = ["Ahmet", "Can", 2022, 2022 - 1990, true, ages];

console.log(people);

//? kisiler icerisindeki yaslar dizisinde bulunan 55 yasini konsola yazdiriniz.

const age55 = people[5][2];
console.log(age55);
...
sayilar.sort((a, b) => a - b); //*if b-a, it shows the number from big to small
console.log(sayilar);
...
array1.fill(1, 2, 4); //* 2-4 indexes will be 1
console.log(array1);
...
console.log(yazilar.join(" ")); //! We can combine the arrays as together like a whole sentence
